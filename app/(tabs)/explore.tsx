      ...
      >
        <View style={[styles.headerSection, { paddingTop: insets.top + webTopInset + 12, maxWidth: isDesktop ? 960 : undefined, alignSelf: isDesktop ? "center" as const : undefined, width: isDesktop ? "100%" : undefined }]}>
          <View style={{ flexDirection: "row" as const, alignItems: "center" as const, gap: 8 }}>
            ...
            <InfoBubble title="Explore" message={`Browse the complete Trust Layer ecosystem of ${ECOSYSTEM_APPS.length} interconnected apps spanning DeFi, governance, identity, social, gaming, AI, and more.`} size={18} />
          </View>
          <Text style={styles.subtitle}>{ECOSYSTEM_APPS.length} Apps. One Ecosystem.</Text>
