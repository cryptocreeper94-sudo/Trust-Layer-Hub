...
const FAQ_ITEMS = [
  { q: "What is Trust Layer?", a: "Trust Layer is a unified blockchain ecosystem of 38 interconnected applications spanning DeFi, security, gaming, AI, enterprise, and more. All apps share a single identity through TrustLink SSO." },
  { q: "How do I get a Trust Layer ID?", a: "Sign up through the Hub app or any ecosystem app. Your Trust Layer ID (TLID) is created during registration and works across all 38 apps." },
