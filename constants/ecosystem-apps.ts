...
export const ECOSYSTEM_APPS: EcosystemApp[] = [
  ...
  },
  {
    ...
    description: "The first programming language designed to eliminate cognitive distance between human intent and machine execution. Lume treats AI as a first-class primitive with native keywords like 'ask', 'think', and 'generate'. Features Voice-to-Code, Certified-at-Birth security with the Guardian Output Scanner, a 7-layer Tolerance Chain, and a self-sustaining runtime. 15 milestones, 552+ tests, 305 acceptance criteria.",
